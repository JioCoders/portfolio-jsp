...
-- changeset jio:002-update-users-for-splitwise
ALTER TABLE users ADD COLUMN full_name VARCHAR(255);
ALTER TABLE users ADD COLUMN phone VARCHAR(20);

-- changeset jio:003-create-groups-table
CREATE TABLE groups (
...
-- changeset jio:004-create-group-members-table
...
-- changeset jio:005-create-expenses-table
...
-- changeset jio:006-create-expense-distributions-table
...
-- changeset jio:007-create-settlements-table
...
-- changeset jio:008-create-audit-logs-table
